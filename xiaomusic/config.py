...
class Config:
    ...
    group_play_mode: str = os.getenv(
        "XIAOMUSIC_GROUP_PLAY_MODE", "auto"
    )  # auto/all/master/single; auto/all 会对同组所有设备下发播放，master 仅下发到主音箱
    group_play_master: str = os.getenv(
        "XIAOMUSIC_GROUP_PLAY_MASTER", ""
    )  # group_name:did,group_name2:did2
    remove_id3tag: bool = (
